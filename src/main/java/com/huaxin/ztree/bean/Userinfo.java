...
public class Userinfo implements Serializable {
	...
	private static final long serialVersionUID = -6074271768209568010L;
	...
	public String toString() {
		return "Userinfo{" + "uid=" + uid + ", uname=" + uname + ", sex=" + sex + ", password=" + password
				+ ", telphone=" + telphone + ", address=" + address + ", utype=" + utype + ", ucourse=" + ucourse + "}";
	}
