...
<head>
    ...
    <script type="text/javascript">
        ...
        function getpage(res) {
        	//{"list1":[{"answer":[{"question":{"qid":"4028abad6841fc5c016841fff992000a"}}],"qanswer":"A","qcourse":"1","qid":"4028abad6841fc5c016841fff992000a","qname":"Java是面向对象的编程","qscore":"2","qstage":"1","qtype":"1"}],"list2":[],"list3":[],"number1":1,"number2":1,"number3":1,"qcourse":"1","qstage":"1","qtype1":"1","qtype2":"2","qtype3":"3"}
            var listfirst = "";
